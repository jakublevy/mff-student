...
select Soupiska.Id as 'Id soupisky', Soupiska.Zapsal_Id as 'Id zapisovatele', Reg_Id AS 'Reg. č.', Hráč_Kontakt.Jméno, Hráč_Kontakt.Příjmení, dbo.Ml_Kategorie_Formátované(dbo.Urči_Ml_Kategorii(Reg_Id), Muž) as 'Hráčská kat.', 
	   Hráč_Kontakt.Email, dbo.Tel_Číslo(Hráč_Kontakt.Tel_Id) as 'Tel. číslo', Hráč_Soupiska.Číslo as 'Číslo dresu', Hráč_Soupiska.Náhradník from Soupiska
...
as
select Jméno, Příjmení, Email, dbo.Tel_Číslo(Tel_Id) as 'Tel. č.', Soupiska.Id as 'Id soupisky', COUNT(Hráč_Soupiska.Hráč_Reg_Id) as 'Počet zapsaných' from Soupiska
...
as 
select Reg_Id AS 'Reg. č.', Jméno, Příjmení, dbo.Ml_Kategorie_Formátované(dbo.Urči_Ml_Kategorii(Reg_Id), Muž) as 'Hráčská kat.', Email, dbo.Tel_Číslo(Tel_Id) as 'Tel. číslo' from Hráč
...
as
select [Reg. č.], Jméno, Příjmení, [Hráčská kat.], Email, [Tel. číslo], Od, Do, Cena_Za_Sezónu as 'Cena za sezónu', Název as 'Mateřský klub' from Hráči
...
as
select h2.Reg_Id AS 'Reg. č.', Jméno, Příjmení, dbo.Ml_Kategorie_Formátované(dbo.Urči_Ml_Kategorii(h2.Reg_Id), h2.Muž) as 'Hráčská kat.', Email, dbo.Tel_Číslo(Tel_Id) as 'Tel. číslo', 
       [Počet odehraných utkání], [Z toho náhradníkem], (([Počet odehraných utkání] - [Z toho náhradníkem]) / nullif([Počet odehraných utkání], 0)) * 100 as '% v základu' from
(
...
as
select Klub.Název as 'Název klubu', Ulice, Č_p as 'Č. p.', Město, Psč, COUNT(Utkání.Místo_Konání_Id) as 'Počet odehraných utkání' from Adresa
...
select Jméno, Příjmení, Email, dbo.Tel_Číslo(Tel_Id) as 'Tel. č.', Klub.Název as 'Místo', COUNT(Utkání.Rozhodčí_Id) as 'Počet odpískaných utkání' from Rozhodčí
...
as
select dbo.Ml_Kategorie_Formátované(Název, Muži) as 'Název', COUNT(Utkání.Ml_Kategorie_Název) as 'Počet odehraných utkání' from Ml_Kategorie
...
as
select Jméno, Příjmení, Email, dbo.Tel_Číslo(Tel_Id) as 'Tel. č.', COUNT(Soupiska.Zapsal_Id) as 'Počet zapsaných soupisek' from Kontakt 
...
as
select Klub.Název as 'Název klubu', Ulice, Č_p as 'Č. p.', Město, Psč, Jméno as 'Jméno správce', Příjmení as 'Příjmení správce', Email as 'Email správce', dbo.Tel_Číslo(Tel_Id) as 'Tel. č. správce' from Klub
